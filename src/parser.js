...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c16 = "bool(",
      peg$c17 = peg$literalExpectation("bool(", false),
      peg$c18 = ")",
      ...
      peg$c45 = function(head, tail) { return {type: "array", value: [head].concat(tail)}; },
      peg$c46 = function(values) {
      ...
      peg$c51 = /^[^\0-\x1F"\\{}]/,
      peg$c52 = peg$classExpectation([["\0", "\x1F"], "\"", "\\", "{", "}"], true, false),
      peg$c53 = function(id) {
        return id
      },
      peg$c54 = /^[1-9]/,
  ...
  function peg$parsebooleanTemplate() {
    var s0, s1, s2, s3;
  ...
  function peg$parsenumberTemplate() {
    var s0, s1, s2, s3;
